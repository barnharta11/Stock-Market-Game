...
Create Table transactions (
	...
	Constraint fk_transactions_stocks_user_games Foreign Key (user_game_id) References user_games(user_game_id),
	Constraint fk_transactions_stocks_stocks Foreign Key (stock_id) References stocks(stock_id),
